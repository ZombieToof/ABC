        ...
        <div class="content">
            ...
            <div class="content-middle">
                <div class="content-middle-box">
                	<div class="large-heading">Delisted</div>
                    You have been removed from <?php echo $campaign->state < 4 ? 'the draft list' : 'the sign up list'; ?>. If you still wish to attend you can reaply from the <a href="index.php">home page</a>.
                </div>
            </div>
            <div class="clear"></div>
        </div>
